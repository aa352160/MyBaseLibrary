package com.rongke.baselibrary.view.recycler.footer;
 ...
 */
public class ClassicLoadMoreView extends FrameLayout implements PullRefreshLayout.OnPullListener {
    private TextView tv;
    private AVLoadingIndicatorView loadingView;
    private PullRefreshLayout refreshLayout;
    private ObjectAnimator objectAnimator;

    public ClassicLoadMoreView(@NonNull Context context, final PullRefreshLayout refreshLayout) {
        super(context);
...
//        setBackgroundColor(ContextCompat.getColor(getContext(), R.color.color_white));
    ...
    private void initView() {
        ...
        loadingView.setIndicatorColor(ContextCompat.getColor(getContext(), R.color.primary_text_color));
