package com.rongke.baselibrary.view.recycler.header;
...
import com.rongke.baselibrary.view.recycler.header.pathview.PathsDrawable;
 ...
 */
public class ClassicsRefreshHeader extends NestedRelativeLayout implements PullRefreshLayout.OnPullListener {
    ...
    public ClassicsRefreshHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
        mHeaderText.setTextColor(ContextCompat.getColor(getContext(), R.color.primary_text_color));
        mArrowDrawable.parserColors(0xff666666);
        mLastUpdateText.setTextColor(ContextCompat.getColor(getContext(), R.color.primary_text_color));
        mProgressDrawable.setColor(ContextCompat.getColor(getContext(), R.color.primary_text_color));
    }
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        RelativeLayout.LayoutParams lpProgress = new RelativeLayout.LayoutParams(20, 20);
        lpProgress.rightMargin = 20;
        ...
        mArrowDrawable.parserColors(ContextCompat.getColor(getContext(), R.color.primary_text_color));
        ...
        mShared = context.getSharedPreferences("ClassicsRefreshHeader", Context.MODE_PRIVATE);
        setLastUpdateTime(new Date(mShared.getLong(KEY_LAST_UPDATE_TIME, System.currentTimeMillis())));
    }

    //<editor-fold desc="API">
    public ClassicsRefreshHeader setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }

    public ClassicsRefreshHeader setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }

    public ClassicsRefreshHeader setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }

    public ClassicsRefreshHeader setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }

    public ClassicsRefreshHeader setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }

    public ClassicsRefreshHeader setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public ClassicsRefreshHeader setLastUpdateTime(Date time) {
        mLastTime = time;
    ...
    public ClassicsRefreshHeader setTimeFormat(DateFormat format) {
        mFormat = format;
